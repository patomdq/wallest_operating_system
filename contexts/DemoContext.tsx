...
export const demoData = {
  ...
  movimientos: [
    { id: 'dm-10', fecha: '2026-03-18', tipo: 'Gasto'   as const, categoria: 'Servicios',  concepto: 'Pinturas García',                          monto:   -3500, cuenta: 'CaixaBank JV Nexo', forma_pago: 'Transferencia', proyecto_id: DEMO_REFORMA_ID, proveedor: 'Pinturas García',          observaciones: null, numero_factura: 'F-2026-050', proyecto_nombre: 'Reforma Edificio Nexo (Edificio Nexo)' },
    { id: 'dm-09', fecha: '2026-03-15', tipo: 'Gasto'   as const, categoria: 'Servicios',  concepto: 'Electricidad Almería factura 2',            monto:   -4300, cuenta: 'CaixaBank JV Nexo', forma_pago: 'Transferencia', proyecto_id: DEMO_REFORMA_ID, proveedor: 'Electricidad Almería',     observaciones: null, numero_factura: 'F-2026-040', proyecto_nombre: 'Reforma Edificio Nexo (Edificio Nexo)' },
    { id: 'dm-08', fecha: '2026-03-01', tipo: 'Gasto'   as const, categoria: 'Materiales', concepto: 'Reformas Mediterráneo certificación 1',     monto:   -5000, cuenta: 'CaixaBank JV Nexo', forma_pago: 'Transferencia', proyecto_id: DEMO_REFORMA_ID, proveedor: 'Reformas Mediterráneo SL',  observaciones: null, numero_factura: 'F-2026-030', proyecto_nombre: 'Reforma Edificio Nexo (Edificio Nexo)' },
    { id: 'dm-07', fecha: '2026-02-10', tipo: 'Gasto'   as const, categoria: 'Servicios',  concepto: 'Electricidad Almería factura 1',            monto:   -4200, cuenta: 'CaixaBank JV Nexo', forma_pago: 'Transferencia', proyecto_id: DEMO_REFORMA_ID, proveedor: 'Electricidad Almería',     observaciones: null, numero_factura: 'F-2026-020', proyecto_nombre: 'Reforma Edificio Nexo (Edificio Nexo)' },
    { id: 'dm-06', fecha: '2026-02-01', tipo: 'Gasto'   as const, categoria: 'Materiales', concepto: 'Reformas Mediterráneo anticipo',            monto:  -10000, cuenta: 'CaixaBank JV Nexo', forma_pago: 'Transferencia', proyecto_id: DEMO_REFORMA_ID, proveedor: 'Reformas Mediterráneo SL',  observaciones: null, numero_factura: 'F-2026-010', proyecto_nombre: 'Reforma Edificio Nexo (Edificio Nexo)' },
